...
subprojects {
    ...
    aliucord {
        author("arm8086", 686327998441324559L)
        updateUrl.set("https://raw.githubusercontent.com/problematic-scripter/AliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/problematic-scripter/AliucordPlugins/builds/%s.zip")
    }
    ...
    dependencies {
        ...
        implementation("org.jsoup:jsoup:1.11.3") // For web scraping
    }
}
